...
public static class IdGenerator
{
    ...
    {
        get { return IdGenerator._hostHash; }
    ...
    /// <returns></returns>
    public static string NewBase36(string overrideHostString, byte? overrideReservedByte = null)
    {
    ...
    /// <returns></returns>
    public static IdFields Parse(string value) {
        ...
        fields.Id = ret;
        fields.HostHash = ret.Substring(10, 2);
        fields.Reserved = ret.Substring(12, 1);
        fields.InService = _inService;
        int pos = Base36Converter.CharList.IndexOf(fields.Reserved);
